...
HeightColorNode.prototype.evaluateHash = function() {
    var inputsValues = [];
...
HeightColorNode.prototype.checkProperties = function() {
...
HeightColorNode.prototype.onExecute = function() {
    ...
    if (!this.colorTexture) {
        ...
        this.fboColor = new FrameBuffer(this.heightmapOBJ.size, this.heightmapOBJ.size, this.colorTexture, "heightColor", setFilterUniformsCallback);
    } else {

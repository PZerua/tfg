...
//name to show
SubFilterNode.title = "Sub Filter";

//function to call when the node is executed
SubFilterNode.prototype.onExecute = function() {
    ...
    this.fboFilter = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, filterTexture, "subFilter", setFilterUniformsCallback);
    ...
    // Create framebuffer providing the texture and a custom shader
    this.fboFilterColor = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, filterTextureColor, "subFilter", setFilterColorUniformsCallback);
...
SubFilterNode.prototype.onDrawBackground = function(ctx)
{
...
LiteGraph.registerNodeType("heightmap/subFilter", SubFilterNode);

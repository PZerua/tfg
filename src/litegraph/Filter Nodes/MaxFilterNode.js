...
MaxFilterNode.prototype.onExecute = function() {
    ...
    this.fboFilter = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, filterTexture, "maxFilter", setFilterUniformsCallback);
    ...
    // Create framebuffer providing the texture and a custom shader
    this.fboFilterColor = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, filterTextureColor, "maxFilter", setFilterColorUniformsCallback);
...
LiteGraph.registerNodeType("heightmap/maxFilter", MaxFilterNode);
